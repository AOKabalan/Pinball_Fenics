...
def plot_u_solution():
    df_u = pd.read_csv('runs/run_1_Pinball_20241209_162049_c7216192/error_analysis/error_analysis/solution_u.csv', sep=';')
...
def plot_p_solution():
    df_p = pd.read_csv('runs/run_1_Pinball_20241209_162049_c7216192/error_analysis/error_analysis/solution_p.csv', sep=';')
