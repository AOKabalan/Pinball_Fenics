...
Transfinite Curve{14} = RHO1*3;
Transfinite Curve{29,31} = RHO1*3;
Transfinite Curve{33,34} = RHO1*3*2.5;
Transfinite Curve{27,28} = RHO1;
Transfinite Curve{1,2,3,4} = RHO1*2;
Transfinite Curve{5,6,7,8} = RHO1*2;
Transfinite Curve{9,10,11,12} = RHO1*2;
