...
Curve Loop(4) = {23, 13, 24, -16};
Line Loop(5) = {22, 16, 25, -15};
Line Loop(6) = {21, 15, 26, 14};

Plane Surface(4) = {4};
Plane Surface(5) = {5};
Plane Surface(6) = {6,1,2,3};



RHO1 = 20;

Transfinite Curve{14} = RHO1*1.7;
Transfinite Curve{1,2,3,4} = RHO1;
Transfinite Curve{5,6,7,8} = RHO1;
Transfinite Curve{9,10,11,12} = RHO1;
...
Physical Surface("FluidDomain") = {4,5,6};
