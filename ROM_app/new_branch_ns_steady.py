...
config = {
    "simulation_name": "PinballSimulation",
    "tolerances": {
        "rom": 1e-16,  # Reduced Order Model tolerance
    },
    "max_basis": {
        "rom": 12,    # Maximum number of ROM basis functions
    },
    "snapshots": {
        "training": 40,  # Number of training snapshots
    ...
    "bifurcation": {
        ...
        "Re_num": 50,    # Number of points for bifurcation analysis
...
def CustomizeReducedNavierStokes(ReducedNavierStokes_Base):
    class ReducedNavierStokes(ReducedNavierStokes_Base):
        ...
        def _project_initial_state(self, initial_state, N):
            ...
            return self.project(initial_state, N_max)
